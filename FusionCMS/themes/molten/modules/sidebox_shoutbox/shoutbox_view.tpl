...
<div id="shoutbox">
	{if $logged_in == false}
		<form class="border_box self_clear" onSubmit="UI.alert('{lang('molten_sidebox_shoutbox_login_please', 'theme_molten')}');return false;">
			<textarea name="shoutbox_content" class="border_box" placeholder="{lang('molten_sidebox_shoutbox_login_please', 'theme_molten')}" disabled="disabled"></textarea>
			<div class="shout_characters_remaining"><span id="shoutbox_characters_remaining">0 / 255</span></div>
			<input type="submit" id="shoutbox_submit" value="{lang('molten_sidebox_shoutbox_submit', 'theme_molten')}" />
		</form>
	{else}
		<form class="border_box self_clear" onSubmit="Shoutbox.submit(); return false">
			<textarea id="shoutbox_content" class="border_box" placeholder="{lang('molten_sidebox_shoutbox_enter_message', 'theme_molten')}" onFocus="this.style.height='70px';" onBlur="window.setTimeout(function() { $('#shoutbox_content').height('16px'); },700);" onkeyup="UI.limitCharacters(this, 'shoutbox_characters_remaining')" maxlength="255" spellcheck="false"></textarea>
			<div class="shout_characters_remaining"><span id="shoutbox_characters_remaining">0 / 255</span></div>
			<input type="submit" name="shoutbox_submit" value="{lang('molten_sidebox_shoutbox_submit', 'theme_molten')}" />
		</form>
	{/if}
